...
All scripts must pass [ShellCheck](https://www.shellcheck.net/). The CI pipeline runs ShellCheck automatically on every push and pull request that touches `scripts/*.sh`.
...
4. Ensure `npm run docs:build` succeeds if you changed documentation
